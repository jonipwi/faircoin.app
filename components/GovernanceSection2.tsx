                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500">
                        ...
                        {proposal.status === 'active' && (
                          <span className="text-blue-500 font-medium">{formatTimeRemaining(proposal.end_date)}</span>
                        )}
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="text-gray-900 dark:text-white font-medium">
                        {(proposal.current_participation * 100).toFixed(1)}% / {(proposal.quorum_percentage * 100).toFixed(0)}% required
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-400">
                          For: {proposal.votes_for} ({((proposal.votes_for / (proposal.votes_for + proposal.votes_against)) * 100).toFixed(0)}%)
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-red-500" />
                        <span className="text-sm text-gray-600 dark:text-gray-400">
                          Against: {proposal.votes_against} ({((proposal.votes_against / (proposal.votes_for + proposal.votes_against)) * 100).toFixed(0)}%)
                        </span>
                      </div>
                    </div>
                  </div>
