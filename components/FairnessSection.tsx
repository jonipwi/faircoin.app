      ...
      <section id="fairness" className="section">
        <div className="container">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">Loading fairness metrics...</p>
          </div>
        </div>
      </section>
    )
      ...
      <div className="container">
        ...
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass">
            ...
            <span className="text-sm font-medium text-white">Fairness Metrics</span>
          </div>
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Transparent metrics showing how FairCoin promotes equitable distribution and prevents concentration of wealth.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="card p-6 group">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">Gini Coefficient</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Inequality measure</p>
                </div>
              </div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                0.0 = Perfect equality, 1.0 = Maximum inequality. Lower is better.
              </p>
            </div>
            ...
            <div className="card p-6 group">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">Average PFI</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Community contribution</p>
                </div>
              </div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Median: {distribution.distribution.median_pfi.toFixed(1)}
              </p>
            </div>
            ...
            <div className="card p-6 group">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white">Fairness Score</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">PFI Leaderboard</h3>
              </div>
                ...
                {leaderboard.leaderboard.slice(0, 5).map((entry) => (
                  <div key={entry.rank} className="flex items-center gap-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">PFI</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {antiConcentration && (
              <div className="card p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Anti-Concentration</h3>
                </div>
                <div className="space-y-4">
                  <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Velocity Requirement</span>
                    ...
                    <div className="flex justify-between items-center mt-2">
                      <p className="text-xs text-gray-500">
                        Current: {(antiConcentration.metrics.concentration_prevention.current_average_velocity * 100).toFixed(1)}%
                      </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 rounded-lg bg-orange-50 dark:bg-orange-900/20">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">Hoarding Penalties</p>
                    </div>
                    <div className="text-center p-3 rounded-lg bg-emerald-50 dark:bg-emerald-900/20">
                      <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                        {antiConcentration.metrics.concentration_prevention.circulation_bonus_recipients}
                      </p>
                      <p className="text-xs text-gray-600 dark:text-gray-400">Circulation Bonuses</p>
                    </div>
                  </div>

                  <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Max Individual Share</p>
                    ...
                    <p className="text-xs text-gray-500">Well below maximum limit</p>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="text-center">
          <div className="card p-8 bg-gradient-to-br from-primary-500/10 to-accent-500/10 border border-primary-500/20">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
              Every transaction and contribution helps build a more equitable economic system. 
              Start earning PFI by participating in the community today.
            </p>
