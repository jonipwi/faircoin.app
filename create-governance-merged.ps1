# Create Merged GovernanceSection Component
# Combines GovernanceSection2 UI/UX with GovernanceSection complete data
...
Write-Host "✅ Merged GovernanceSection.tsx created successfully!"
Write-Host ""
Write-Host "Features:"
Write-Host "  - GovernanceSection2 UI/UX (compact card style)"
Write-Host "  - Complete data from GovernanceSection (author, quorum_percentage, current_participation, time_remaining)"
Write-Host "  - New voting progress layout:"
Write-Host "    * Top: Total Participation (votes, %) + Quorum (%)"
Write-Host "    * Middle: Progress bar"
Write-Host "    * Bottom: For (qty, %) LEFT | Against (qty, %) RIGHT"
